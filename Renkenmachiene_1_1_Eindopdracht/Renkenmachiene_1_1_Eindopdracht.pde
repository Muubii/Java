...
Button addButton, minusButton, multiplyButton, divideButton, equalsButton, clearButton;
String input = ""; // Invoer
...
void setup() {
  ...
  addButton = new Button(240, 440, 80, 80, "+");
  minusButton = new Button(240, 360, 80, 80, "-");
  multiplyButton = new Button(240, 280, 80, 80, "*");
  divideButton = new Button(240, 200, 80, 80, "/");
  equalsButton = new Button(320, 360, 80, 160, "=");
